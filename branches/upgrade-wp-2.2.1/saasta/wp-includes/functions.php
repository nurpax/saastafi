...
// TODO: implement properly (muumi)
function saasta_print_header() {

	$auth = get_the_author();
	$title = get_the_title();
	$time = get_the_time('F jS, Y');

	$ret = '<table style="border:1px solid #eaeaea;width:100%;" border="0" cellspacing="0" cellpadding="0">';
	$ret .= '<tr><td rowspan="2" style="padding:5px;width:40px;border-right:1px solid #eaeaea;align:center;vertical-align:center;"><img src="people/'.$auth.'.png" border="0" alt="Muumi" title="Muumi"/></td>';
	$ret .= '<td style="font-size:large;font-weight:bold;padding:5px;width:100%;border-bottom:1px solid #eaeaea;">'.$title.'</td>';
	$ret .= '</tr><tr>';
	$ret .= '<td style="width:100%;padding:5px;font-size:small;">'.$time.' by '.$auth.'</td>';
	$ret .= '</tr></table>';
